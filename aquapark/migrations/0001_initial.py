    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Пользователь'), ('cashier', 'Кассир'), ('admin', 'Администратор')], default='user', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ticket_type', models.CharField(choices=[('adult', 'Взрослый'), ('child', 'Детский'), ('family', 'Семейный'), ('vip', 'VIP')], max_length=10, verbose_name='Тип билета')),
                ...
                ('visitor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aquapark.visitor', verbose_name='Посетитель')),
            ],
            options={
                'verbose_name': 'Билет',
