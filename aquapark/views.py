...
def user_login(request):
    ...
    return render(request, 'aquapark/login.html', {'form': form})
...
def user_register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            user.save()
            login(request, user)
            messages.success(request, f'Регистрация успешна! Добро пожаловать, {user.username}! Ожидайте назначения роли администратором.')
            return redirect('dashboard')
    else:
        form = RegisterForm()
    
    return render(request, 'aquapark/register.html', {'form': form})
...
def dashboard(request):
    if request.user.role == 'user':
        return render(request, 'aquapark/waiting_approval.html')
    ...
    return render(request, 'aquapark/dashboard.html', context)
...
def employees_list(request):
    ...
    return render(request, 'aquapark/employees.html', {'employees': employees})
...
def visitors_list(request):
    ...
    return render(request, 'aquapark/visitors.html', {'visitors': visitors})
...
def tickets_list(request):
    ...
    return render(request, 'aquapark/tickets.html', {'tickets': tickets})
@login_required
def add_employee(request):
    ...
    return render(request, 'aquapark/add_employee.html', {'form': form})
...
def add_visitor(request):
    ...
    return render(request, 'aquapark/add_visitor.html', {'form': form})
...
def add_ticket(request):
    ...
    return render(request, 'aquapark/add_ticket.html', {'form': form})
@login_required
def edit_employee(request, employee_id):
    ...
    return render(request, 'aquapark/edit_employee.html', {
        'form': form, 
        'employee': employee,
...
def delete_employee(request, employee_id):
    ...
    return render(request, 'aquapark/delete_employee.html', {'employee': employee})
...
def edit_visitor(request, visitor_id):
    ...
    return render(request, 'aquapark/edit_visitor.html', {'form': form, 'visitor': visitor})
...
def delete_visitor(request, visitor_id):
    ...
    return render(request, 'aquapark/delete_visitor.html', {'visitor': visitor})
...
def edit_ticket(request, ticket_id):
    ...
    return render(request, 'aquapark/edit_ticket.html', {'form': form, 'ticket': ticket})
...
def delete_ticket(request, ticket_id):
    ...
    return render(request, 'aquapark/delete_ticket.html', {'ticket': ticket})
